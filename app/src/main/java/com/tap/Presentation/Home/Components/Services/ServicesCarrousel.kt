...
fun ServicesCarrousel(
    ...
    Row(modifier= Modifier
        ...
        Text(section, fontWeight = FontWeight.Black, modifier = Modifier.padding(bottom=20.dp,top=20.dp))
        Row(){
            Button(
                colors = ButtonDefaults.buttonColors(
            ...
            Button(
                ...
                onClick = { if(section=="Mis servicios básicos"){
                        navController.navigate("agregarGenerico")
                    }else{
